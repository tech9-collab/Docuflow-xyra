// // pages/EmiratesResultPage/EmiratesResultPage.jsx
import { useLocation } from "react-router-dom";
import { useMemo } from "react";
import "./EmiratesResultPage.css";

export default function EmiratesResultPage() {
  ...
  const {
    ...
    apiDownloadUrl,           // <-- get from state (set in EmiratesId.jsx)
    authToken,                // <-- get from state (set in EmiratesId.jsx)
  } = state || {};
